...
import vacinaResolve from './vacina-routing-resolve.service';

describe('Vacina routing resolve service', () => {
  let mockRouter: Router;
  let mockActivatedRouteSnapshot: ActivatedRouteSnapshot;
  let service: VacinaService;
  let resultVacina: IVacina | null | undefined;
  ...
  describe('resolve', () => {
    it('should return IVacina returned by find', () => {
      ...
      TestBed.runInInjectionContext(() => {
        vacinaResolve(mockActivatedRouteSnapshot).subscribe({
          next(result) {
            resultVacina = result;
          },
        });
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultVacina).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IVacina>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
